...
public class App {
    public static void main(String[] args) {
        ...
        Contact c1 = new Contact(1, "Madhu", "madhu@gmail.com", "9876543210");service.addContact(c1);
        System.out.println("Added: " + service.getContact(1).getName());service.deleteContact(1);
